const data = [
    ...
    },
    {
        quote: "Report in",
        audio: () => {
            const audio = new Audio(require("./assets/audio/Legacy_ct_reportingin.mp3"));
            audio.play();
        }
    },
    {
    ...
    },
    {
        ...
        audio: () => {
            const audio = new Audio(require("./assets/audio/Legacy_ct_fireinhole.mp3"));
            audio.play();
        }
    },
    {
    ...
    },
    {
        ...
        audio: () => {
            const audio = new Audio(require("./assets/audio/okteamfollowmycommand.mp3"));
            audio.play();
        }
    },
    {
    ...
    },
    {
        ...
        audio: () => {
            const audio = new Audio(require("./assets/audio/Bomb Has Been Planted - CS GO - QuickSounds.com.mp3"));
            audio.play();
        }
    },
    {
